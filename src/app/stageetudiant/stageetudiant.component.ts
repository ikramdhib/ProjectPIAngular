...
export class StageetudiantComponent {
  ...
  onSubmit(event: Event) {
    ...
    const formData = {
      ...
      startAt: this.startAt.toString(), // Convertir la date en chaîne ISO
    ...
    try {
      ...
      this.stageService.ajouterStage(formData).subscribe((response) => {
        console.log("Succès de l'ajout du stage:", response);
